...
SWFMG_bs9<- NA
MB_df<- MB_df %>% 
  bind_rows(extract_MBmetadata(data = SWFMG_bathy9, Site = "SWFMG", Subsite = "9", Type = "Bathymetry", Source = "CSCAMP")) %>%
  bind_rows(extract_MBmetadata(data = SWFMG_bs9, Site = "SWFMG", Subsite = "9", Type = "Backscatter", Source = "CSCAMP"))
...
MB_df<- MB_df %>% 
  bind_rows(extract_MBmetadata(data = SWFMG_bathyCombined, Site = "SWFMG", Subsite = "UptoDec2018", Type = "Bathymetry", Source = "CSCAMP"))
